from ssd.data.datasets import VOCDataset, COCODataset, PolypDataset
from .coco import coco_evaluation
from .voc import voc_evaluation
from .polyp import polyp_evaluation
...
def evaluate(dataset, predictions, output_dir, **kwargs):
    ...
    elif isinstance(dataset, PolypDataset):
        return polyp_evaluation(**args)
    else:
