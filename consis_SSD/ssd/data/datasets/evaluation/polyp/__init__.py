...
from .eval_detection_polyp import eval_detection_voc


def polyp_evaluation(dataset, predictions, output_dir, iteration=None):
    ...
    result_str = "mAP: {:.4f}\n".format(result["map"])
    metrics = {'mAP': result["map"], 'prec': result["precision"], 'rec': result["recall"]}
