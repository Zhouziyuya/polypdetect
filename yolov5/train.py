...
def parse_opt(known=False):
    ...
    parser.add_argument('--consis_mode', type=str, default=None, help='lr or ud, left and right or up and down')
    ...
    parser.add_argument('--hyp', type=str, default='data/hyps/hyp_renji.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--name', default='renji_conv3', help='save to project/name')
